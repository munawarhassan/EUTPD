...
export class ElementAnimateUtil {
    ...
    public static animateClass(element: HTMLElement, animationName: string, callBack?: (ev: Event) => void): void {
    ...
    public static transitionEnd(element: HTMLElement, callBack: (ev: Event) => void) {
        DOMEventHandlerUtil.one(element, 'transitionend', callBack);
    }

    public static animationEnd(element: HTMLElement, callBack: (ev: Event) => void) {
        DOMEventHandlerUtil.one(element, 'animationend', callBack);
    }
