...
export class DOMEventHandlerUtil {
    ...
    public static on(element: HTMLElement, selector: string, eventName: string, callBack: (ev: Event) => void): string {
    ...
    public static one(element: HTMLElement, eventName: string, callBack: (ev: Event) => void): void {
