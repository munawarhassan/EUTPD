...
import { DefaultMenuOptions, MenuWrapper } from './menu';
...
class SearchComponent {
    ...
    processing = false;
    menuObject: MenuWrapper | undefined;
    ...
    public static getInstance(
        ...
        const Search = DataUtil.get(el, componentName) as SearchComponent;
        if (Search) {
            return Search;
        }
    ...
    constructor(_element: HTMLElement, _options: ISearchOptions, _queries: ISearchQueries) {
        ...
        if (this.layout === 'menu') {
            this.menuObject = new MenuWrapper(this.contentElement, 'dropdown', DefaultMenuOptions);
        }
    ...
    private getOption = (name: string) => {
        ...
        if (attr) {
            ...
            const option = getObjectPropertyValueByKey(this.options, optionName) as string;
            if (option) {
