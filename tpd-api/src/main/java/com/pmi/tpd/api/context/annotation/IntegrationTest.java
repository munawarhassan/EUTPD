...
/**
 * Indicates that a component is eligible for registration when {@code "integration-test"} profile is active.
 * <p>
 * <b>Note</b>: Using only this profile to specify a Spring configuration or specific bean to use during integration
 * testing.
 * </p>
 *
 * @see Profile
