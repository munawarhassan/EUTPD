 ...
 * CookieLocaleResolver#StringUtils.parseLocaleString(localePart) is not able to parse the locale. This class will check
 * if a double quote has been added, if so it will remove it.
 */
